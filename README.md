...
For this week, we decided to build a Mancala game using Spring. I'm allowed to work on it only Sunday.
...
## About the project
More information about the game and rules: https://en.wikipedia.org/wiki/Mancala

### How to run:
1.  Compile and run the Spring Boot application.
2.  Open your browser and navigate to `http://localhost:8080`.

<img width="1328" height="725" alt="image" src="https://github.com/user-attachments/assets/a837c2ba-c25f-48cb-b52b-d321d157ef29" />
